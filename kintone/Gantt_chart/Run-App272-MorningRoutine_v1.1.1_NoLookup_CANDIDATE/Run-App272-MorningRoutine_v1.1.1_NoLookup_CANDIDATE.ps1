...
<#
.SYNOPSIS
  App272 Morning Routine v1.1.1 NoLookup
...
param(
    ...
    [string]$NewPostScript = 'C:\HPDB\Import-App272_Phase1C_New_v0.7.5_NoLookup_CANDIDATE.ps1',
...
try {
    ...
    Write-Host '================================================================='
    Write-Host 'App272 Morning Routine v1.1.1 NoLookup'
    Write-Host '================================================================='
