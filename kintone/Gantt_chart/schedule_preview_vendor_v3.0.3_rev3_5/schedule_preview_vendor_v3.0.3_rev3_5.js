(function () {
  ...
  function buildApplyUpdates(records, selectedVendor, offsets) {
    ...
    records.forEach(function (record) {
      ...
      const currentProvisional = getValue(record, CONFIG.provisionalField);
      ...
      result.updates.push({
        ...
        record: {
          ...
          [CONFIG.provisionalField]: { value: CONFIG.provisionalOnValue },
    ...
    records.forEach(function (record) {
      ...
      result.updates.push({
        ...
        record: {
          ...
          [CONFIG.provisionalField]: { value: CONFIG.provisionalOffValue },
          [CONFIG.scheduleTypeField]: { value: CONFIG.autoValue }
        }
      });
    });
