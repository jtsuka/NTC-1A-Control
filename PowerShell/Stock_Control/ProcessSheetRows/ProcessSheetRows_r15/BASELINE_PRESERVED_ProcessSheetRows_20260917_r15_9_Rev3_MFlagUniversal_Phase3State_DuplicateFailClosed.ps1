...
$ScriptVersion = "2026-09-17-r15.9-MFlagUniversal-Phase3State"
$excel = $null
$workbook = $null
$varExcel = $null
$varWorkbook = $null
...
try {
    ...
    if ($Mode -eq "Update") {
        ...
        $hasBaseWorkbookChanges = (($candidates.Count -gt 0) -or ($unitPriceFormulaFixes.Count -gt 0) -or $hasNewProductChanges -or $hasPhase3Changes)
