<#
===============================================================================
AdjustInventoryChart_XMLTest_r6.ps1
...
$ScriptVersion = "2026-09-02-chart-xml-r6"
...
try {
    ...
    # r6 (2026-09-02): Update時のバックアップ/一時ファイル生成で参照する $folder が
    #   未定義のため、Set-StrictMode下で「変数が設定されていない」エラーとなり
    #   グラフ更新前に停止していた。他2スクリプトと同様、ワークブックの親フォルダを
    #   ここで求めておく（本体は書き換え前に停止するため既存ブックは破損しない設計）。
