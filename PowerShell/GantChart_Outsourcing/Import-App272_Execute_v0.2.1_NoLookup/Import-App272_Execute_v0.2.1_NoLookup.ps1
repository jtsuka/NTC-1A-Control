...
.NOTES
  ...
  v0.2.1 NoLookupはPUTのみ実装し、POST/DELETEは実装しない。App272のルックアップフィールドには依存しない。
#>
...
# -------------------- main --------------------
$started = Get-Date
Write-Host '=== App272 API自動取込 Phase 1B Safe Execute v0.2 ExcelMaster ===' -ForegroundColor Cyan
