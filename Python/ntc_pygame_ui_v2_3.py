#!/usr/bin/env python3
# ntc_pygame_ui_v2_3.py
# NTC-1A single-channel Main Controller GUI.
#
# v2.3:
# - Left column is SETTING/COMMAND input for the 1ch replacement controller.
# - Right column is read-only ACTUAL/MONITOR from TC106 Direction-B telemetry.
# - Boot Magic is never displayed as telemetry (handled in serial comm v1.3.4).
# - Existing hidden Phase3 regression-test panel is preserved.
#
# Historical note:
...
pygame.display.set_caption("NTC-1A Main Controller UI v2.3")
