# Next_Main_GUI_v7_5.py – テンキー均一＆最下段修正＋ログ表示改善版
...
root = tk.Tk()
root.title("NTC-1A Touch Panel – v7.5")
...
log_text = tk.Text(center_frame, height=5, bg="black", fg="lime", font=("Consolas", 12), highlightthickness=1, highlightbackground="white")
log_text.grid(row=0, column=0, columnspan=2, sticky="nsew", padx=5, pady=5, ipady=8)
def out(msg):
